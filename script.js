...
function wallChange() {
    if (start === 0) {
        document.getElementById("parent").style.backgroundImage = "url(https://ibrakh.github.io/main.jpg)";
        document.getElementById("small").style.background = "linear-gradient(45deg, rgb(223, 181, 126), rgb(172, 131, 131))";
        start++
    } else {
        document.getElementById("parent").style.backgroundImage = "url(https://ibrakh.github.io/secend.jpg)";
